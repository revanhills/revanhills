...
export default function BookPage() {
  ...
  return <main className="booking-page-new"><SiteHeader /><div className="booking-back-strip"><div className="shell"><Link className="back-link" href="/"><ArrowLeft size={17} /> Back to property</Link></div></div><div className="shell booking-page-grid"><section><p className="eyebrow">DIRECT BOOKING REQUEST</p><h1>Let’s find your stay.</h1><p className="booking-intro">Choose the stay, dates and group details. We’ll prepare a WhatsApp request for the host; this does not charge you or confirm the booking.</p>
